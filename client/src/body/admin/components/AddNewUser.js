            ...
            <div className='newUser'>
                <form>
                    ...
                    <input type='password' placeholder='Slaptažodis' value={ password } 
                        onChange={(e) => this.setState({password: e.target.value})} autoComplete='password'></input><br/>
                    <label>Administratorius</label>
                    <input type='checkbox' unchecked='true' onChange={() => this.setState({admin: !admin})}></input><br/>
